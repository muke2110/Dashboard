...
app.post('/admin_Dashboard/uploadCertificates', upload.fields([{ name: 'pdfFileInput', maxCount: 1 }, { name: 'csvFileInput', maxCount: 1 }]), async (req, res) => {
    try {
        ...
        console.log("Body: ", req.body.namePositionX);
        ...
        const coordinates = {
            namePositionX: req.body.namePositionX,
            namePositionY: req.body.namePositionY,
            eventPositionX: req.body.eventPositionX,
            eventPositionY: req.body.eventPositionY,
            datePositionX: req.body.datePositionX,
            datePositionY: req.body.datePositionY
        };
