            ...
            jwt.verify(token, secretKey, async (err, decoded) => {
                if (err) {
                    ...
                    if (decoded.role === 'student') {
                        ...
                        // Check if 'success' query parameter is true and display an alert message
                        const success = req.query.success === 'true';
                        if (success) {
                            res.render('student_Dashboard', { students, roll_number: decoded.roll_number, successMessage: 'Issue reported successfully!' });
                        } else {
