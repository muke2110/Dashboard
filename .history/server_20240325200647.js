...
app.post('/test', (req, res) => {
    ...
    // Now you can access the coordinates data
    console.log(coordinates);
    // You can access individual coordinates like this:
    const nameCoordinates = coordinates.Name;
    const eventNameCoordinates = coordinates['Event Name'];
    const dateCoordinates = coordinates.Date;
    // Access x and y values of each coordinate
    const nameX = nameCoordinates.x;
    const nameY = nameCoordinates.y;
    // Similarly for other coordinates

    // Handle the rest of your backend logic here

    res.send('Received coordinates data successfully');
});
