...
app.post('/test', (req, res) => {
    // Log the raw request body to see what data is being received
    console.log(req.body);
    
    try {
        // Access the coordinates array from the request body
        const coordinates = JSON.parse(req.body.coordinates);
        
        // Now you can use the coordinates array as needed
        console.log(coordinates); // Example: Output the coordinates array to the console
