...
app.post('/UploadRecords', (req, res, next) => {
    upload.single("file")(req, res, async function (err) {
        ...
        const id = req.body.const id = req.body.certificate_id;
        ...
        if (req.file) {
            ...
            await collection_student.updateOne(
                ...
                { $push: { certificate_path: `${path}` } },
                { $push: { certificate_id: ${id}}}
            );
        } else {
...
app.post('/users/login', async (req, res) => {
    ...
    if(req.body.role =='student'){
        ...
        try {
            ...
            const students = await collection_student.findOne({"roll_number": roll_number });
