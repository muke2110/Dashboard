...
for (let index = 0; index < data.length; index++) {
    ...
    doc
        .fontSize(20)
        .text(`Certificate for ${Name}`, parseInt(req.body.coordinates.Name.x), parseInt(req.body.coordinates.Name.y));
    doc
        .fontSize(20)
        .text(`Event: ${eventName}`, parseInt(req.body.coordinates['Event Name'].x), parseInt(req.body.coordinates['Event Name'].y));
    doc
        .fontSize(20)
        .text(`Date: ${certificateDate}`, parseInt(req.body.coordinates.Date.x), parseInt(req.body.coordinates.Date.y));
