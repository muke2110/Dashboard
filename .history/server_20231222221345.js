...
const student = require('./Modules/studentFiles');
const cookieParser = require('cookie-parser');

const port = 3000;
const secretKey = 'Mukesh@2110';
...
app.post('/users/login', async (req, res) => {
    try {
        if (req.body.role === 'student') {
            ...
            // Store the token in a secure way (e.g., in a cookie or client-side storage)
            res.cookie('U_id', token, { httpOnly: true, maxAge: 24 * 60 * 60 * 1000 }); // Set the expiration time as needed
