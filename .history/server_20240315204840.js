...
app.post('/forgetPassword', async (req, res) => {
    console.log(req.body)
    const { identifier:roll_number, role } = req.body;
    ...
    try {
        ...
        console.log(user); // Ensure that user object contains all necessary data, including email

        // Access email from user object
        const userEmail = user.email;
        console.log(userEmail); // Verify that email is accessible
