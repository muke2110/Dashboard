...
async function overlayTextOnTemplate(templatePDFBuffer, name, eventName, certificateDate, coordinates) {
    try {
        ...
        const yCoordinateName = page.getHeight() - coordinates.namePositionY * pixelsToPoints;
        const xCoordinateEventName = coordinates.eventPositionX * pixelsToPoints;
        const yCoordinateEventName = page.getHeight() - coordinates.eventPositionY * pixelsToPoints;
        const xCoordinateDate = coordinates.datePositionX * pixelsToPoints;
        const yCoordinateDate = page.getHeight() - coordinates.datePositionY * pixelsToPoints;
