...
async function overlayTextOnTemplate(templatePDFBuffer, name, eventName, certificateDate, coordinates) {
    try {
        ...
        const xOffsetName = 20; // Adjust this value based on your requirements
        const yOffsetName = 20; // Adjust this value based on your requirements
        const xOffsetEventName = 20; // Adjust this value based on your requirements
        const yOffsetEventName = 20; // Adjust this value based on your requirements
        const xOffsetDate = 20; // Adjust this value based on your requirements
        const yOffsetDate = 20; // Adjust this value based on your requirements
