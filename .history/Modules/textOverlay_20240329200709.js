...
async function overlayTextOnTemplate(templatePDFBuffer, name, eventName, certificateDate, coordinates) {
    try {
        ...
        const xOffsetName = 140; // Adjust this value based on your requirements
        const yOffsetName = 140; // Adjust this value based on your requirements
        const xOffsetEventName = 140; // Adjust this value based on your requirements
        const yOffsetEventName = 140; // Adjust this value based on your requirements
        const xOffsetDate = 140; // Adjust this value based on your requirements
        const yOffsetDate = 140; // Adjust this value based on your requirements
