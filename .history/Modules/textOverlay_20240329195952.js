...
async function overlayTextOnTemplate(templatePDFBuffer, name, eventName, certificateDate, coordinates) {
    try {
        ...
        // Add offsets for fine-tuning the position
        const xOffsetName = 10; // Adjust this value based on your requirements
        const yOffsetName = 10; // Adjust this value based on your requirements
        const xOffsetEventName = 10; // Adjust this value based on your requirements
        const yOffsetEventName = 10; // Adjust this value based on your requirements
        const xOffsetDate = 10; // Adjust this value based on your requirements
        const yOffsetDate = 10; // Adjust this value based on your requirements
