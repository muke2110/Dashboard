...
const {upload , saveFilePathsToDB} = require('./Modules/Multer');
...
app.post('/admin_Dashboard/uploadCertificates', upload.fields([{ name: 'pdfFileInput', maxCount: 1 }, { name: 'csvFileInput', maxCount: 1 }]), saveFilePathsToDB,async (req, res) => {
    try {
