...
app.post('/UploadRecords', (req, res, next) => {
    upload.single("file")(req, res, async function (err) {
        ...
        // Continue with your logic if no MulterError
        ...
        if (existingStudent && req.file && req.file.path) {
            ...
            await collection_student.updateOne(
                ...
                { $push: { certificate_path: `${req.file.path}` } }
            );
        } else {
            console.log("Invalid Student_id, No File Uploaded, or File Path not available");
        }
