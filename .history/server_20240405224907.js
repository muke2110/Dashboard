...
app.get('/viewDetails', (req, res) => {
    // Retrieve PDF and XLSX paths from query parameters
    const pdfPath = req.query.pdf;
    const xlsxPath = req.query.xlsx;

    // Render viewDetails.ejs template and pass PDF and XLSX paths to it
    res.render('viewDetails', { pdfPath, xlsxPath });
});
