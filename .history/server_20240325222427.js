...
app.post('/test', (req, res) => {
    // Access the coordinates data from the request body
    const coordinatesData = req.body.coordinates;
    ...
    // Handle the coordinates data as needed
    // For example, you can save it to a database or perform any other processing

    // Send a response to the client
    res.send('Coordinates received successfully');
});
