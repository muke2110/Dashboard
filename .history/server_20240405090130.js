...
const {collection_admin, collection_student, issueForm, collection_history} = require('./mongodb'); // Imported from your MongoDB file
const multer = require('multer'); // 5. multer
const jwt = require('jsonwebtoken'); // 6. jwt
const otpGenerator = require('otp-generator'); // 7. otpGenerator
const { student, adminInfo, emailRetrieve } = require('./Modules/retrieveDetails'); // Imported from your retrieveDetails module
const { sendEmailWithAttachment, sendOTP } = require('./Modules/emailServices'); // Imported from your emailServices module
const upload = require('./Modules/Multer'); // Imported from your Multer module
const {saveFilePathsToDB} = require('./Modules/Multer'); // Imported from your Multer module
const cookieParser = require('cookie-parser'); // 11. cookieParser
const bodyParser = require('body-parser'); // 12. bodyParser
const xlsx = require('xlsx'); // 13. xlsx
const overlayTextOnTemplate = require('./Modules/textOverlay'); // Imported from your textOverlay module
const cors = require('cors'); // 15. cors
...
app.post('/admin_Dashboard/uploadCertificates', upload.fields([{ name: 'pdfFileInput', maxCount: 1 }, { name: 'csvFileInput', maxCount: 1 }]), async (req, res) => {
    try {
        ...
        console.log('Coordinates', coordinates); // Ensure coordinates are correct
